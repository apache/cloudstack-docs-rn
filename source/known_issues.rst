...
`CLOUDSTACK-6917 <https://issues.apache.org/jira/browse/CLOUDSTACK-6917>`_  dashboard view for regular user should have more information...
...
`CLOUDSTACK-6982 <https://issues.apache.org/jira/browse/CLOUDSTACK-6982>`_  [UI] Nic details page is missing link for add secondary ip to mic....
...
`CLOUDSTACK-7029 <https://issues.apache.org/jira/browse/CLOUDSTACK-7029>`_  listCapacity fails when podid argument is specified...
...
`CLOUDSTACK-6920 <https://issues.apache.org/jira/browse/CLOUDSTACK-6920>`_  Support listing of LBHealthcheck policy with LBHealthcheck policy ID...
...
`CLOUDSTACK-6933 <https://issues.apache.org/jira/browse/CLOUDSTACK-6933>`_  registering an iso fails in KVM deployment....
...
`CLOUDSTACK-6994 <https://issues.apache.org/jira/browse/CLOUDSTACK-6994>`_  [Automation] Secondary storage counts for a project does not include the resorce...
`CLOUDSTACK-6999 <https://issues.apache.org/jira/browse/CLOUDSTACK-6999>`_  Creating storage pool failing with simulator with NullPointerException...
...
`CLOUDSTACK-7026 <https://issues.apache.org/jira/browse/CLOUDSTACK-7026>`_  mark the test_01_primary_storage_iscsi as test that requires hardware...
`CLOUDSTACK-7027 <https://issues.apache.org/jira/browse/CLOUDSTACK-7027>`_  Leftover of SNAT rule was causing network down under L3 switch...
`CLOUDSTACK-7028 <https://issues.apache.org/jira/browse/CLOUDSTACK-7028>`_   Static NAT does not work after the fail-ove...
`CLOUDSTACK-7031 <https://issues.apache.org/jira/browse/CLOUDSTACK-7031>`_  [Automation] deployDataCenter.py issues...
`CLOUDSTACK-7047 <https://issues.apache.org/jira/browse/CLOUDSTACK-7047>`_  DeploymentPlanner should include disabled resources only when the VM owner is Ad...
